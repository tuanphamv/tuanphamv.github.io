$(document).ready(function () {
  ...
  var normalNav = function(){
    ...
    if (scrollTop > normalNavTop) { 
        $('#section-menu').css({ 'position': 'fixed', 'top':0, 'left':0, 'z-index':9999, 'width': '100%', 'background-color': '#0F1E23' });
    } else {
      $('#section-menu').css({ 'position': 'relative', 'background-color': 'transparent' });
    }
  };
